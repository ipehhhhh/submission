...
data1_path = os.path.join(path, r"C:\Users\syari\Document\KULIAH\Semester_6_BANGKIT\submission\dashboard\main_data_Changping.csv")
Changping_df = pd.read_csv(data1_path)

path = os.path.dirname(__file__)
data2_path = os.path.join(path, r"C:\Users\syari\Document\KULIAH\Semester_6_BANGKIT\submission\dashboard\main_data_Dongsi.csv")
...
merge_database.to_csv(r'C:\Users\syari\Document\KULIAH\Semester_6_BANGKIT\submission\dashboard\main_data.csv', index=False)
